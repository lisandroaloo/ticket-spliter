      ...
      <section className="w-full flex justify-center items-center  bg-gray-900">
        <div className="w-full  flex-col flex justify-center items-center my-28">
          ...
          <p className="mt-4 text-white">
            Our expense tracking app offers a range of features to make managing
          ...
          <div className="mt-8 w-11/12 flex flex-col gap-4 ">
            <FeatureCard
              ...
              description={
                "Create and manage projects with name, description, and member assignment."
              }
            />
            <FeatureCard
              ...
              description={
                "Determine how much each member should pay or receive based on the expense distribution."
              }
            />
            <FeatureCard
              ...
              description={
                "View detailed reports and transaction history for your projects and expenses."
              }
            />
          </div>
        </div>
